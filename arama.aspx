<%@Page Title="Enverin Kod Defteri||Arama" MetaDescription="Enver Yıldırım Blog, Kodlarım,Deneyimlerim ve Araştımalarım" MetaKeywords="enver yıldırım,asp.net,c#,tsql,asp.net mvc,android" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="arama.aspx.cs" Inherits="myblog.arama" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h4 id="aranan" runat="server"></h4>
