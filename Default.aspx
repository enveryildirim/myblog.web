<%@ Page Title="Enverin Kod Defteri" MetaDescription="Enver Yıldırım Blog, Kodlarım,Deneyimlerim ve Araştımalarım" MetaKeywords="enver yıldırım,asp.net,c#,tsql,asp.net mvc,android" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="myblog.Default" %>
